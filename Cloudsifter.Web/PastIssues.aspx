<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PastIssues.aspx.cs" Inherits="Cloudsifter.Web.PastIssues" %>
<!DOCTYPE html>
            ...
            <div class="main wrapper clearfix">
                ...
                <article>
                    <header>
                        <h1>Past Issues</h1>
                        <p>
                            This is where the bodies are hidden... It might be last weeks news (or even the week before), but
							there's still good stuff to be had here, in case you weren't previously 
							<a href="/subscribe" target="_blank">subscribed</a> to the updates.
                        </p>
                    </header>
<asp:Repeater ID="newslettersRepeater" runat="server">
	<ItemTemplate>
                    <section>
                        <h2><a href="/past/<%# DataBinder.Eval(Container.DataItem, "PublishDate.Month")%>/<%# DataBinder.Eval(Container.DataItem, "PublishDate.Day")%>/<%# DataBinder.Eval(Container.DataItem, "PublishDate.Year")%>"><%# DataBinder.Eval(Container.DataItem, "Name") %> - <%# DataBinder.Eval(Container.DataItem, "PublishDate", "{0:dd MMM yyyy}")%></a></h2>
                        <p>
