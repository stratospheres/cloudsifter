<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Link.aspx.cs" Inherits="Cloudsifter.Web.Link" %>
        ...
        <div class="main-container">
            <div class="main wrapper clearfix">
                ...
                <article>
                    ...
                    <section>
						<h3>Visit the link:</h3>
						<h4><asp:Literal ID="urlLiteral" runat="server" /></h4>
						<h3>Spotted by:</h3>
<asp:Repeater ID="linkSpotterRepeater" runat="server">
	<ItemTemplate><a href="<%# (string.IsNullOrEmpty(((string)DataBinder.Eval(Container.DataItem, "URL"))) ? "#" : DataBinder.Eval(Container.DataItem, "URL"))  %>" target="_blank"><em><%# DataBinder.Eval(Container.DataItem, "FullName")%></em></a></ItemTemplate>
